...
object Versions {
  ...
  const val androidx_test_espresso_espresso_core: String =
    "3.1.1" // exceed the version found: 3.1.0

  const val androidx_test: String = "1.1.1" // exceed the version found: 1.1.0
  ...
  const val exoplayer: String = "2.9.0" //available: "2.9.2"

  const val com_google_dagger: String = "2.19"

  const val firebase_crash: String = "16.2.1"

  const val google_services: String = "4.2.0" //available: "4.2.0"

  const val rxbinding_kotlin: String = "2.2.0" //available: "2.2.0"
